					...
					<ul class="nav nav-inline">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu">                     
								...
								<a class="dropdown-item" href="<c:url value='/animal/bird/main.aw' />"><img src="<c:url value='/resources/images/animal/bird.png'/>" style="width:30px;height:30px;"/>  조류</a>
								<a class="dropdown-item" href="<c:url value='/animal/etc/main.aw' />"><img src="<c:url value='/resources/images/animal/rat.png'/>" style="width:30px;height:30px;"/>  기타 포유류</a>
								<a class="dropdown-item" href="<c:url value='/animal/freeboard.aw' />">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;자유 게시판</a>
							</div>
						</li>             
						<li class="nav-item dropdown">
