...
//해당 글번호에 대한 코멘트 목록을 가져오는 함수 
	var showComments = function(key){		
		$.ajax({
			url:"<c:url value='/animal/rnaTip/cmt_list.awa'/>",
			data:{no:key},
			dataType:'json',
			type:'post',
	...
	var displayComments	 = function(data){
		...
		$('.commentDelete').click(function(){			
			...
			$.ajax({
				url:"<c:url value='/animal/rnaTip/cmt_delete.awa'/>",
	...
	$(function(){
		...
		$('#submit').click(function(){	
			if($(this).val()=='등록')
				var action="<c:url value='/animal/rnaTip/cmt_write.awa'/>";
			else
			    var action = "<c:url value='/animal/rnaTip/cmt_edit.awa'/>";
