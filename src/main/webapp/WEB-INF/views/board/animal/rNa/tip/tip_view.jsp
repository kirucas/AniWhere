...
<script>
	var isDelete = function(){
		if(confirm("글을 삭제 하시겠습니까?"))
			location.replace("<c:url value='/board/animal/rNa/tip/delete.aw?tip_no=${record.tip_no}'/>");
	};
</script>
<style>
					...
					<div class="article__title">
						...
						<div style="float:right;">
							...
							<c:if test="${sessionScope.mem_no==record.mem_no }">
								<a href="<c:url value='/board/animal/rNa/tip/edit.aw?tip_no=${record.tip_no}'/>" class="article-action__button button">수정</a>
