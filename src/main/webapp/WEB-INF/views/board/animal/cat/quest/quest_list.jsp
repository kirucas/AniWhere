...
<div class="container">
	<div class="page-header">
		<h2>
			고양이&nbsp;<small>질문 게시판</small>
		</h2>
	</div>
	<div>
		<form action='<c:url value="/security/animal/cat/quest/quest_write.aw"/>'>
			<div class="offset-md-9 col-md-3" style="padding: 5px;padding-right: 0px">	
				<div align="right">
					<a href="<c:url value='/security/animal/cat/quest/quest_write.aw'/>"class="btn btn-sm btn-outline-success" style="font-size:15px"><i class="fas fa-edit fa-lg"></i> 글쓰기</a>
				</div>
			</div>
		</form>
	</div>
				...
				<c:if test="${not isEmpty }">
					<c:forEach var="record" items="${list}" varStatus="loop">
						<tr>
							...
							<td>
								<a style="color:black;" href="<c:url value='/animal/cat/quest/quest_view.aw?no=${record.dto.no}'/>">${record.dto.quest_title}
	...
	<div class="row offset-md-3 col-md-7">
		<div class="form-row">
			<form class="form-inline" style="padding-bottom: 10px" method="post"
				action="<c:url value='/animal/cat/quest/quest_list.aw'/>">
