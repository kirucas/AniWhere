...
var isDelete = function(){	
	...
	var showComments = function(key){		
		$.ajax({
			url:"<c:url value='/board/animal/cat/movie/commentList.awa'/>",
			data:{no:key},
			dataType:'json',
			type:'post',
	...
	$(document).on('click','.commentDelete',function(){
		...
		$.ajax({
			url:"<c:url value='/board/animal/cat/movie/commentDelete.awa'/>",
	...
	$(function(){	//페이지 로드시 코멘트 목록 뿌려주기
		...
		$('#submit').click(function(){
			...
			if($(this).html()=='댓글')
				var action="<c:url value='/security/animal/cat/movie/commentWrite.awa'/>";
			else
				var action="<c:url value='/security/animal/cat/movie/commentEdit.awa'/>";
