	...
	$(function(){
		...
		function sendFile(file, el, wel) {
			...
			$.ajax({
				data: form_data,
				type: "POST",
				url : "<c:url value='/animal/cat/quest/Upload.aw'/>",
				cache: false,
				contentType: false,
				processData: false,
...
<div class="container border">
	...
	<form id="frm" class="form-horizontal" method="post"
		action='<c:url value="/security/animal/cat/quest/quest_reply.aw"/>'>
		<div class="form-row">
		...
		<div class="form-row" style="padding-top: 10px;padding-bottom: 20px">
			...
			<textarea autofocus="autofocus" data-msg="내용을 입력하세요" required="required" class="form-control summer" name="quest_content" id="quest_content" rows="30" placeholder="내용을 입력해주세요"></textarea>
		</div>
		<div class="form-row">
			...
			<input type="hidden" id="ani_category" name="ani_category" value="2" />
