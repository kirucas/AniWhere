...
$(function() {
	$('#.sel'.option).each(function(){
	    if($(this).val()=='${record.tip_category}'){
...
<div class="container">
	...
	<div style="width:100%">
		<form method="post" action="<c:url value='board/animal/bird/tip/write.aw'/>">
			<div class="form-group form-row">
				<input type="hidden" name="tip_no"/>
				<input type="hidden" name="mem_no" value="${mem_no}" />
                 	<select id="sel" name="tip_category"style="width:53px;height:38px;margin-right:10px;">
