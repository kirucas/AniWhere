...
<div class="container">
	<form name="fr" method="post" onsubmit="return check()" action="<c:url value='/security/animal/etc/movie/Write.aw'/>">
		<input type="hidden" name="mem_no" value="${mem_no }">
		<input type="hidden" name="ani_category" value="5">
		<div class="form-group row">
			...
			<div class="col-sm-9 ">
				<input type="text" class="form-control-planintext"
					id="validationDefaultUsername" value="기타포유류 게시판" disabled="disabled"
					placeholder="기타포유류 게시판">
				<!-- required disabled -->
			</div>
		</div>
		<div class="form-group row">
