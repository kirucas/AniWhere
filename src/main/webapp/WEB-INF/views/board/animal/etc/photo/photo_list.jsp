	    ...
	    <div class="modal-content">
	      <div class="modal-body">
	        <div class="swiper-container" id="popupGallery">
			  ...
			  <div class="swiper-slide text-xs-center text-lg-center">
				 <img class="img-thumbnail" src="<c:url value='/resources/images/board/animal/etc/etc_15.jpg' />" alt="사진이 없습니다.">
			  </div>
			  <div class="swiper-slide text-xs-center text-lg-center">
				 <img class="img-thumbnail" src="<c:url value='/resources/images/board/animal/etc/etc_14.jpg' />" alt="사진이 없습니다.">
			  </div>
	          </div>
