		...
		<form method="post" action="<c:url value='/animal/freeboard/write.aw'/>">
			<div class="form-group form-row">
				...
				<div class="form-row" style="width:87.5%;"id="titlediv">
					<input type="text" class="form-control" id="title" name="free_title" placeholder="제목을 입력하세요">
				</div>
			</div>
			<script>	
			...
			<div class="form-group form-row">
				<div style="width:92.75%">
					<textarea rows="10" class="form-control" id="summernote" name="free_content"></textarea>
				</div>
			</div>
			<div class="form-group form-row">
