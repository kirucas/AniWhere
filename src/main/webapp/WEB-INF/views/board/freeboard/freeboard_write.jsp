...
<div class="container">
	...
	<div style="width: 100%">
		<form method="post"
			action="<c:url value='/security/animal/freeboard/write.aw'/>">
			<div class="form-group form-row">
				<input type="hidden" name="no" /> <input type="hidden" name="mem_no"
					value="${mem_no}" /> <select name="free_category"
			...
			<div class="form-group form-row">
				<div style="width: 92.75%">
					<textarea rows="10" class="form-control" id="summernote"
						name="free_content"></textarea>
				</div>
			</div>
			<div class="form-group form-row">
				<div class="col-sm-offset-2">
					<button type="submit"
						class="article-action__button button button--red button--red--border">등록</button>
				</div>
			</div>
		</form>
	</div>
