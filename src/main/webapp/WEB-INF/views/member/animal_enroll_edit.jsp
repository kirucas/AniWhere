		    	...
		    	<form action="<c:url value='/enrollProcess.aw'/>" class="col s12" method="post" enctype="multipart/form-data">
			      <div class="row">
			        <div class="input-field col s4 offset-s4">
			          <input id="ani_name" name="ani_name" type="text" class="validate" value="${record.ani_name }">
			          <label for="ani_name">애완동물 이름</label>
			        </div>
			      </div>
			      <div class="row">
			      	<div class="input-field col s4 offset-s4">
			      		 <input id="ani_age" name="ani_age" type="text" class="validate" value="${record.ani_age }">
				  ...
				  <div class="row">
			        <div class="input-field col s4 offset-s4">
			          <input id="ani_kind" name="ani_kind" type="text" class="validate" value="${record.ani_kind }">
