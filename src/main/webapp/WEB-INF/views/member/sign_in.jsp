                        ...
                        <div class="auto-form-wrapper d-flex align-items-center justify-content-center flex-column">
                            <form action="<c:url value='/signInProcess.aw' />" method="post">
                                ...
                                <div style="width: 480px;">
                                	<a href="${url }">
                                		<img id="naverLogin" src="https://developers.naver.com/doc/review_201802/CK_bEFnWMeEBjXpQ5o8N_20180202_7aot50.png" style="width: 480px;height: 80px;margin-bottom: 30px;"/>
                               		</a>
                  				</div>
