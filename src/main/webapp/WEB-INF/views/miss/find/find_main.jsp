		...
		<div class="sub-header-info">
			<div>
				...
				<div class="sub-header-search">
					<a href="<c:url value='/miss/find_write.aw'/>"> <img
						style="float: left; margin-top: 5px;"
						src="https://talk.op.gg/images/icon-write@2x.png" alt="글쓰기"
						width="24">
					</a>
					<form style="display: inline;"
						action="<c:url value='/miss/find.aw'/>">
				...
				<article class="article-list-item">
					<div class="article-list-item__content">
						<span id="animal_code"> <c:choose>
							...
							</c:choose> <span>[${record.dto.addr}]</span>
						</span> <a
							href="<c:url value='/miss/find_view.aw?find_no=${record.dto.no}'/>"
						...
						<div class="article-list-item-meta">
							<div class="article-list-item-meta__item">
								<span data-tooltip data-date="2018-09-27T05:45:00+00:00"
									title="">${record.dto.regidate }</span>
							</div>
							<div
					...
					<div class="article-list-item__vote">
						<div>
							<span id="no" style="text-align: center">${totalRecordCount - (((nowPage - 1) * pageSize) + loop.index)}</span>
						</div>
					</div>
				</article>
