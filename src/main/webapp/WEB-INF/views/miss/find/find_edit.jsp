...
<div class="container">
	...
	<div style="width:100%">
		<form method="post" action="<c:url value='/security/miss/find_update.aw?find_no=${record.no}'/>">
			...
			<div class="form-inline">
 				<div class="form-group">
 					<input type="text" class="form-control" style="width: 250px" placeholder="예)금천구 가산동" name="addr" id="address" value="${record.addr}">    							
		...
		<a href="<c:url value='/miss/find_view.aw?find_no=${record.no}'/>"><button class="article-action__button button button--red button--red--border" style="float: left; margin-left: 15px">취소</button></a>
	</div>
</div>
<!-- 내용 끝 -->
