		...
		<div class="sub-header-info">
			<div>
				...
				<div class="sub-header-search">
					<a href="<c:url value='/miss/see_write.aw'/>"> <img
						style="float: left; margin-top: 5px"
						src="https://talk.op.gg/images/icon-write@2x.png" alt="글쓰기"
						width="24">
					</a>
					<form style="display: inline"
						action="<c:url value='/miss/see.aw'/>">
			...
			<c:forEach var="record" items="${see_list}" varStatus="loop">
				<article class="article-list-item">
					<div class="article-list-item__content">
						...
						</span> <span>[${record.dto.addr}]</span> <a
							href="<c:url value='/miss/see_view.aw?see_no=${record.dto.no}'/>"
