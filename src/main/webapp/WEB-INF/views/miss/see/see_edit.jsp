...
<div class="container">
	...
	<div style="width:100%">
		...
		<a href="<c:url value='/miss/see_view.aw?see_no=${record.no}'/>"><button class="article-action__button button button--red button--red--border" style="float: left; margin-left: 15px">취소</button></a>
	</div>
</div>
<!-- 내용 끝 -->
