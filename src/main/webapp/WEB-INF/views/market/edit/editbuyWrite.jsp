...
<body>
	...
	<div class="container">
		...
		<div class="col-md-12">
			...
			<form method="post" action="<c:url value='/market/buyupdate.aw?buy_no=${record.no}'/>" accept-charset="utf-8" name="buy_info" class="form-horizontal">				
				<div class="form-row">
        ...
        <!--    <input type="hidden" name="mem_no" value="#" /> -->
				...
				<div style="text-align: center" class="form-group">
					...
					<input class="btn btn-danger" type="submit" id="enterBtn" value="수정">
				</div>
