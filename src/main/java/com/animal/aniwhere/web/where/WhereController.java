...
public class WhereController {
	...
	public String mapdata(@RequestParam Map map, HttpServletResponse response) throws Exception {
		...
		for (String code : codes) {
			String API_URL = "http://apis.data.go.kr/B553077/api/open/sdsc/storeListInRadius?radius=2000&type=json&cx="
					+ map.get("lon") + "&cy=" + map.get("lat")
					+ "&ServiceKey=snZhl9X76KcGuXrNuvglRr41nB8iUW9CZ%2F96V4aVUEANTSVsQOIeOM1o7f2cxlsD%2BBOcP%2BElAe12PhHaKfRyTA%3D%3D";
