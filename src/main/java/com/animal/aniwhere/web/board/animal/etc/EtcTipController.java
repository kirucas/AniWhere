...
public class EtcTipController {
	...
	//등록 폼으로 이동 및 입력처리]
	@RequestMapping(value="/animal/etc/tip/write.aw",method=RequestMethod.GET)
	public String write() throws Exception{
		return "board/animal/etc/tip/tip_write.tiles";
	}////////////////
	//입력처리]
	@RequestMapping(value="/animal/etc/tip/write.aw",method=RequestMethod.POST)
	...
	//수정폼으로 이동 및 수정 처리]
	@RequestMapping("/board/animal/etc/tip/edit.aw")
	...
	//Summernote 업로드 기능
	@ResponseBody
    @RequestMapping(value="/board/animal/etc/tip/Upload.aw")
