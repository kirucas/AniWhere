...
@Controller
public class EtQueCmtController {

	@Resource(name="allCommentService")
	private AllCommentService allCommentService;
	
	@ResponseBody
	@RequestMapping(value="/security/etc/quest/cmtWrite.awa",produces="text/html; charset=UTF-8",method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value="/etc/quest/cmtList.awa",produces="text/html; charset=UTF-8",method = RequestMethod.POST)
	...
	@ResponseBody
	@RequestMapping(value="/etc/quest/cmtDelete.awa",produces="text/html; charset=UTF-8",method = RequestMethod.POST)
