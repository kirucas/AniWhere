...
public class CatMovieController {
	...
	//코멘트 입력처리]
			@ResponseBody
			@RequestMapping(value="/security/animal/cat/movie/commentWrite.awa",produces="text/plain; charset=UTF-8")
			...
			@ResponseBody
			@RequestMapping(value="/board/animal/cat/movie/commentList.awa",produces="text/html; charset=UTF-8")
			...
			//코멘트 수정 처리
			@ResponseBody
			@RequestMapping(value="/security/animal/cat/movie/commentEdit.awa",produces="text/html; charset=UTF-8")
			...
			//코멘트 삭제처리]
			@ResponseBody
			@RequestMapping(value="/board/animal/cat/movie/commentDelete.awa",produces="text/html; charset=UTF-8")
