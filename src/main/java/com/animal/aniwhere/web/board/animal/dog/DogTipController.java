...
public class DogTipController {
		...
		//페이징 문자열을 위한 로직 호출]
				if(map.get("searchWord") != null) {
					...
					String pagingString = PagingUtil.pagingBootStrapStyle(totalRecordCount, pageSize, blockPage,nowPage,
							req.getContextPath()+"/board/animal/dog/tip/list.aw?searchColumn="+searchColumn+"&searchWord="+searchWord+"&");
					...
					String pagingString = PagingUtil.pagingBootStrapStyle(totalRecordCount, pageSize, blockPage,nowPage,
							req.getContextPath()+"/board/animal/dog/tip/list.aw?");
					model.addAttribute("pagingString", pagingString);
				}
		//데이터 저장]
	...
	//등록 폼으로 이동 및 입력처리]
	@RequestMapping(value="/security/animal/dog/tip/write.aw",method=RequestMethod.GET)
	public String write() throws Exception{
		return "board/animal/dog/tip/tip_write.tiles";
	}////////////////
	//입력처리]
	@RequestMapping(value="/security/animal/dog/tip/write.aw",method=RequestMethod.POST)
	...
	//수정폼으로 이동 및 수정 처리]
	@RequestMapping("/security/board/animal/dog/tip/edit.aw")
