package com.animal.aniwhere.service.member;
...
public class NaverLoginBO {
	   /* 인증 요청문을 구성하는 파라미터 */
	    ...
	    private final static String CLIENT_ID = "NC0HimpNsqgrzxkQ6lz1";       //네이버API Client ID
	    private final static String CLIENT_SECRET = "p65rKt9DIi";             //네이버API Client Secret      	  
	    private final static String REDIRECT_URI = "http://localhost:10080/aniwhere/Member/naver/Callback.aw";
