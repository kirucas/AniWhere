		...
		<div class="col-md-12">
			...
			<div>
				<div class="row"
					...
					<div class="my-3">
						<span>거래방법</span> <input class="form-control" type="text"
							placeholder="예)직거래,택배등" style="text-align: right" id="wishcount" />
					</div>
					<div class="my-3">
						<span>연락처</span> <input class="form-control" type="text"
							placeholder="집전화,휴대폰번호" style="text-align: right" id="wishcount" />
					</div>
				...
				<div style="text-align: center">
					<a href="<c:url value='/market/sell.aw'/>"><input
